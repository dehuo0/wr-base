...
do_install() {
    ...
    install -d ${D}/opt/benchmark/fs/iozone
    install -m 0755 ${WORKDIR}/runtest.sh ${D}/opt/benchmark/fs/iozone/
    install -m 0755 ${WORKDIR}/diskdetect.sh ${D}/opt/benchmark/fs/iozone/

}

FILES_${PN} += "${datadir}/doc/${PN}/copyright.txt \
                /opt/benchmark/fs/iozone \
"
